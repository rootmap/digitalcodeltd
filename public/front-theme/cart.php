...
<html>
    <head>
        ...
        <title>Cart | Bombay Cottage</title>
				...
				<div class="sectionWrapper">
					<div class="container">
						...
						<div class="block shop-bottom-btns">
							<a class="btn btn-large left" href="shop.php">Continue Shopping</a>
							<a class="btn btn-large main-bg right" href="check-out.php">Proceed to Checkout</a>
						</div>
					</div>
				</div>
