					...
					<div class="container">
						<div class="steps">
							<ul>
								...
								<li class="selected"><span>4 - Confirm Payment</span></li>
							</ul>
						</div>
						<table class="table-style2">
							<tr>
								<th class="left-text">Items To Buy Now</th>
							...
							<tfoot>
								...
								<tr>
									...
									<td class="center">$1720</td>
								</tr>
							</tfoot>
						</table>
						<div class="clearfix"></div>
						<div class="continue-btn">
							<a class="btn btn-medium main-bg right" href="success.php">Confirm Payment</a>
							<a class="btn btn-medium left" href="check-out-step3.php">Back</a>
						</div>
					</div>
				</div>
