...
<html>
    <head>
        ...
        <title>Product | Bombay Cottage</title>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <aside class="cell-3 left-shop">
                                <?php include('include/product_left_bar.php'); ?>
                            </aside>
                            <!-- cell6 -->
                            <div class="cell-6">
                                <div class="button-group">
                                    <a class="btn btn-primary delivery_time_detail online-smart-way model-restaurant-btn fx animated fadeInUp" href="#" data-animate="fadeInUp" data-animation-delay="600" style="animation-delay: 600ms;">
                                ...
                                <div class="cell-12">
                                    <blockquote>
                                        ...
                                        please inform us. Any dish not on the menu, can be prepared on request.
                                    </blockquote>
                                </div>
                                <div class="clearfix"></div>
                                <div class="padd-top-20"></div>
