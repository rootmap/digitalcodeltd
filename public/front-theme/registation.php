...
<html>
    <head>
        ...
        <title>Registation | Bombay Cottage</title>
    ...
    <body>
        ...
        <div id="container_reg" class="sectionWrapper" style="background-image: url('images/bg-01.jpg');">
            <div class="container">
                <div class="row">
                    <div id="wrap_reg">
                        <div class="cell-7 contact-form fx padd-top-35" data-animate="fadeInLeft">
                        ...
                        <div class="cell-5 fx" data-animate="fadeInRight" style="padding-top: 85px;">
                                <div class="notices">
