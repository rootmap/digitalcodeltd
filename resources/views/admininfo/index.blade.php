    ...
    <div class="col-md-12">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <a class="btn btn-info pull-right" href="{{url('admin-ecom/Admin-Info-add')}}"><i class="fa fa-plus"></i> Create New Admin</a>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
...
@include('extra.kendo')
    ...
    <script id="edit_client" type="text/x-kendo-template">
        <a class="k-button k-button-icontext k-grid-delete" href="{{url('admin-ecom/Admin-Info')}}/#= id #"><span class="k-icon k-edit"></span>Edit</a> 
