    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('admin-ecom/welcome-content')}}"><i class="fa fa-circle-o"></i> Welcome Content</a></li>
                            {{-- <li><a href="{{url('admin-ecom/free-home-delivery')}}"><i class="fa fa-circle-o"></i> Free Home Delivery</a></li> --}}
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('admin-ecom/review-title')}}"><i class="fa fa-circle-o"></i> Review Title</a></li>
                            <li><a href="{{url('admin-ecom/Review-Request')}}"><i class="fa fa-circle-o"></i> Review Detail</a></li>
                           
                        </ul>
                    </li>
                    <li><a href="{{url('admin-ecom/order-Info')}}"><i class="fa fa-plus"></i> Order Info</a></li>
                    <li><a href="{{url('admin-ecom/todayoffer')}}"><i class="fa fa-table"></i> Today Offer</a></li>
                    <li><a href="{{url('admin-ecom/table-booking')}}"><i class="fa fa-table"></i> Table Booking</a></li>
                    <li><a href="{{url('admin-ecom/gallery-photo')}}"><i class="fa fa-table"></i> Gallery Photo</a></li>
                    <li><a href="{{url('admin-ecom/new-extra-page')}}"><i class="fa fa-table"></i> New Page </a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="treeview">
                        <a href="#"><i class="fa fa-cogs"></i> <span>Inclusive Menu</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="{{url('admin-ecom/inclusive-meal/create')}}"><i class="fa fa-circle-o"></i> Create Inclusive Menu</a></li>
                            <li><a href="{{url('admin-ecom/inclusive-meal')}}"><i class="fa fa-circle-o"></i> Inclusive Menu List</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{url('admin-ecom/new-delivery-cost')}}"><i class="fa fa-plus"></i> Add New Delivery Cost</a></li>
                    <li><a href="{{url('admin-ecom/delivery-cost')}}"><i class="fa fa-table"></i> Delivery Cost List</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{url('admin-ecom/social')}}"><i class="fa fa-plus"></i> Site Social Link</a></li>
                    <li><a href="{{url('admin-ecom/accept-payment')}}"><i class="fa fa-plus"></i> Accept Payment</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{url('admin-ecom/site/module')}}"><i class="fa fa-plus"></i> Site Module Settings </a></li>
                    <li><a href="{{url('admin-ecom/contact-detail')}}"><i class="fa fa-plus"></i> Site Contact Detail</a></li>
                    <li><a href="{{url('admin-ecom/contact-request')}}"><i class="fa fa-plus"></i> Site Contact Request</a></li>
                    {{-- <li><a href="{{url('admin-ecom/reviews')}}"><i class="fa fa-plus"></i> Site Reviews</a></li> --}}
                    ...
                    <li><a href="{{url('admin-ecom/tax')}}"><i class="fa fa-plus"></i> Tax Settings</a></li>
                    <li><a href="{{url('admin-ecom/apps-setting')}}"><i class="fa fa-plus"></i> Apps Setting</a></li>
                    <li><a href="{{url('admin-ecom/paypalsetting')}}"><i class="fa fa-plus"></i> Paypal Setting</a></li>
                    <li><a href="{{url('admin-ecom/enable-collection-only')}}"><i class="fa fa-plus"></i> Collection Only Setting</a></li>
                </ul>
            </li>
