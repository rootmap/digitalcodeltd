<div id="center_column" class="center_column col-xs-12 col-sm-12 col-md-9">
    ...
    <h1 class="page-heading title_font"><span class="cat-name">{{$cat_info->name}}&nbsp;</span><span class="heading-counter">There are <?=count($product_info)?> products.</span></h1>
                    ...
                    <div class="item-inner">
                        <div class="left-block">
                            <div class="product-image-container">
                                ...
                                <a class="product_img_link product_img" href="{{url('category/brand/sub/sub/'.$cid.'/'.$bid.'/'.$sub_cid.'/'.$pro->id.'/'.$pro->name)}}" title="{{$pro->name}}" itemprop="url"> 
