<div id="center_column" class="center_column col-xs-12 col-sm-12 col-md-12">
    ...
    <h1 class="page-heading title_font"><span class="cat-name">Wishlist &nbsp;</span><span class="heading-counter">There are <?=count($product_info_fetch)?> products.</span></h1>
    ...
    <div class=" hide-color-options hide-stock-info">
        <ul class="product_list grid row">
            ...
            <li class="ajax_block_product col-xs-12 col-sm-6 col-lg-3 first-in-line first-item-of-tablet-line first-item-of-mobile-line">
