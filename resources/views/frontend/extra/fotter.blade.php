        ...
        <div class="container">
            <div class="row">
                ...
                <div class="cell-3">
                    ...
                    <ul>
                        <li class="footer-contact"><i class="fa fa-home"></i><span>{{$ContactDetail->contact_address}}</span></li>
                        <li class="footer-contact"><i class="fa fa-globe"></i><span><a href="mailto:{{$ContactDetail->contact_email}}">{{$ContactDetail->contact_email}}</a></span></li>
                        <li class="footer-contact"><i class="fa fa-phone"></i><span><a href="skype:{{$ContactDetail->contact_phone}}?call">{{$ContactDetail->contact_phone}}</span></a></li>
                        <li class="footer-contact"><i class="fa fa-map-marker"></i><span><a href="{{url('contact-us') }}">View our map</a></span></li>
                    </ul>
                </div>
                ...
                <div class="cell-3">                                
                    ...
                    <p>
                       <a target="_blank" href="{{$AcceptPayment->title_link}}">
                        <img src="{{url('upload/AcceptPayment')}}/<?= $AcceptPayment->images ?>">
                        </a>
                    </p>
                ...
                <div class="cell-3">
                    <h3 class="block-head">{{$ContactDetail->qrcode_section_title?$ContactDetail->qrcode_section_title:'Verify Us with QR Code'}}</h3>
                    <p align="center">
                        <a target="_blank" href="{{$ContactDetail->qrcode_link}}">
                        <img style="height: 140px;" src="{{url('upload/qrcode')}}/{{$ContactDetail->qr_code}}" alt="QRCode">
                        </a>
                    </p>
                ...
                <div class="cell-3 flickr-stream-w">
                    <h3 class="block-head">{{$ContactDetail->social_section_title?$ContactDetail->social_section_title:'Join us on facebook'}}</h3>
                    <?php 
                    ...
                    <a target="_blank" href="{{$social_link}}">
                        <img  src="{{url('upload/social')}}/{{$ContactDetail->social}}">
                    </a>
                </div>
                <!-- flickr stream footer cell start -->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <div class="copyrights cell-4">&copy; {{date('Y')}} Copyrights <b>{{$Seo->name}}</b>. All rights reserved. 
                    {{-- <span><a href="privacy.php">Privacy policy</a> | <a href="terms.php">Terms of use</a></span> --}}
                </div>
