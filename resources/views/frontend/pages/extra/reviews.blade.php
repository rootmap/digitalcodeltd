...
@section('title','Review - Please leave a feedback | ')
@section('seo')
    <meta name="description" content="{{$Seo->reviews_description}}">
                ...
                <div class="cell-7">
                    <section id="slick">
                        ...
                        <div class="feedback-form">
                            ...
                            <form action="{{url('/Review-Request')}}" id="feedback" method="post">
                                <!-- Name input -->
                                ...
                                <div class="field">
                                    ...
                                    @if(isset($data))
                                        ...
                                        @foreach($data as $row)
                                            ...
                                            ?>
                                            <div <?= $class; ?> >
                                                <input type="checkbox" id="satisfaction<?=$i;?>" value="{{$row->name}}" name="satisfaction[]">
                                                <label for="satisfaction<?=$i;?>" class="tick"><span>{{$row->name}}</span></label>
                                            </div>
                                            <?= $divclass; ?>
                                            <?php $i++;?>
                                        @endforeach
