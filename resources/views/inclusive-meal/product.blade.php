...
@section('title','Inclusive Meal Info')
@section('barcum')
<h1>
    All Inclusive Meal
    <small>Create Inclusive Meal Info</small>
</h1>
<ol class="breadcrumb">
    <li><a href="{{url('admin-ecom/inclusive-meal')}}"><i class="fa fa-tags"></i> Inclusive Meal Info</a></li>
    <li><a href="{{url('admin-ecom/inclusive-meal/create')}}" class="active">Create New Inclusive Meal</a></li>
</ol>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-plus"></i> Create New Inclusive Meal</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form method="post" role="form" enctype="multipart/form-data" action="{{url('admin-ecom/inclusive-meal/save')}}">
                <div class="box-body">
                	<div class="row">
                		<div class="col-md-6">
