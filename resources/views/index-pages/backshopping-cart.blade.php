        ...
        <div id="columns" class="container">
            <div class="row" style="padding-top: 10px;">
                ...
                <div id="center_column" class="center_column col-xs-12 col-sm-12 col-md-12">
                        ...
                        <table id="cart_summary" class="table table-bordered stock-management-on">
                            ...
                            <tfoot>
                                <tr class="cart_total_price">
                                    ...
                                    <td colspan="2" class="price" id="total_product">${{$totalPrice}}</td>
                                </tr>
                                ...
                                <tr class="cart_total_price">
                                    ...
                                    <td colspan="2" class="price" id="total_price_container"> <span id="total_price">${{$totalPrice}}</span></td>
                                </tr>
                            </tfoot>
                            <tbody>
                                @if(isset($product))
                                ...
                                <tr id="product_3_13_0_0" class="cart_item last_item first_item address_0 odd">
                                    ...
                                    <td class="cart_description">
                                        <p class="product-name"><a href="">{{$pro['item']->name}}<?php
                                                //echo "<pre>";
                                                //print_r($pro);
                                                ?></a></p> <small class="cart_ref">{{$pro['item']->description}}</small></td>
                                    <td class="cart_avail"><span class="label label-success">In stock</span></td>
                                    <td class="cart_unit" data-title="Unit price">
                                        <ul class="price text-right" id="product_price_3_13_0">
                                            <li class="price">${{$pro['item']->price}}</li>
                                        </ul>
                                    </td>
                                    <td class="cart_quantity text-center" data-title="Quantity">
                                        ...
                                        <div class="cart_quantity_button clearfix">
                                            <a rel="nofollow" class="btn btn-default button-minus" href="{{ route('product.delToCart',['id'=>$pro['item']->id]) }}" title="Subtract"> <span><i class="icon-minus"></i></span> </a> 
                                            <a rel="nofollow" class="btn btn-default button-plus"  href="{{ route('product.addToCart',['id'=>$pro['item']->id,'reur'=>base64_encode('shopping-cart')]) }}" title="Add"><span><i class="icon-plus"></i></span></a></div>
                                    </td>
                                    <td class="cart_delete text-center" data-title="Delete">
                                        <div> <a rel="nofollow" title="Delete"  href="{{route('product.delRowCart',['id'=>$pro['item']->id])}}"><i class="icon-trash"></i></a></div>
                                    </td>
                                    <td class="cart_total" data-title="Total"> <span class="price" id="total_product_price_3_13_0"> ${{$pro['price']}} </span></td>
                                </tr>
                                @endforeach
                                @endif
                            </tbody>
                    ...
                    @if(Auth::check())
                        @include('front-include.shopping-cart-delivery-method')
                    @else
