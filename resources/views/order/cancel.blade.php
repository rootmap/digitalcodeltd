...
@section('barcum')
<h1>
    <i class="fa fa-tag"></i> Orders Cancel Info
    <small>All Cancel Orders List</small>
</h1>
<ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-tags"></i> Cancel Orders Info</a></li>
    <li><a href="#" class="active">Cancel Orders List</a></li>
</ol>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-table"></i> Cancel Orders List</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
...
<script id="edit_client" type="text/x-kendo-template">
    ...
    <a class="k-button k-button-icontext k-grid-delete" href="{{url('admin-ecom/orders')}}/#= id #"><span class="k-icon k-edit"></span>Edit</a> 
