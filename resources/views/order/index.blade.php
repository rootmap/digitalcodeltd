...
@section('barcum')
<h1>
    <i class="fa fa-tag"></i> Orders Info
    <small>All Orders List</small>
</h1>
<ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-tags"></i> Orders Info</a></li>
    <li><a href="#" class="active">Orders List</a></li>
</ol>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-table"></i> Orders List</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
