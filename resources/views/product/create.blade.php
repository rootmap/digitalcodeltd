                ...
                <div class="box-body">
                    ...
                    <div class="form-group categoryField">
                        ...
                        <select class="form-control" id="cid" name="cid">
                            ...
                            @if(!empty($cat))
                                @foreach($cat as $ct)
                                <option value="{{$ct->id}}" layout="{{$ct->layout}}">{{$ct->name}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                        ...
                        <table width="100%" class="table table-bordered table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    <td valign="top">1</td>
                                    <td valign="top"> 
                                        <input type="text" name="dp_name[]" placeholder="Option Name" class="form-control dp_name">  
                                        <input type="hidden" name="dp_no[]" placeholder="Option no" class="form-control hidno" value="{{time()}}">  
                                    </td>
                                    <td valign="top"> 
                                        <input type="text" name="dp_opt[]" placeholder="Option , comma separated" class="form-control">  
                                    </td>
                                    <td valign="top"> 
                                        <select type="text" name="parent_opt[]" class="form-control">
