    ...
    <div class="col-md-12">
        ...
        @if(isset($data))
            <div class="box box-danger">
                ...
                <form  enctype="multipart/form-data"  method="post" role="form" action="{{url('admin-ecom/site/module/update')}}">
                    <div class="box-body">
            ...
            <div class="box box-danger">
                ...
                <form   method="post" role="form" action="{{url('admin-ecom/site/module/add')}}">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Customer Support Number</label>
