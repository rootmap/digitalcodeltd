...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-danger">
            ...
            <form method="post" role="form" enctype="multipart/form-data" action="{{url('admin-ecom/slider-add')}}">
                <div class="box-body">
...
<script id="edit_client" type="text/x-kendo-template">
    <a class="k-button k-button-icontext k-grid-delete" href="{{url('admin-ecom/slider')}}/#= id #"><span class="k-icon k-edit"></span>Edit</a> 
