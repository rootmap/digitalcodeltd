...
<h1>
    Contact Pages Info
    <small>Create Contact Pages Info & All Contact List</small>
</h1>
<ol class="breadcrumb">
    <li><a href="#" class="active">Contact Page Info</a></li>
</ol>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-plus"></i> Create New Contact Pages</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->

            <form method="post" role="form" enctype="multipart/form-data" action="<?php echo e(url('admin-ecom/Contact-Pages-add')); ?>">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Page Title Name</label>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-table"></i> Contact Pages List</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
...
<script id="edit_client" type="text/x-kendo-template">
    <a class="k-button k-button-icontext k-grid-delete" href="<?php echo e(url('admin-ecom/Contact-Pages')); ?>/#= id #"><span class="k-icon k-edit"></span>Edit</a> 
...
//$("#brandimage").kendoUpload();
    ...
    dataSource: dataSource,
            ...
            {field: "name", title: "Page Name", width: "150px"},
            {field: "heading", title: "Page Title", width: "150px"},
