				...
				<form action="javascript:void(0);" id="reg_form" class="contact-form">
					<div class="cell-6">
    					...
    					<?php else: ?>
		    				...
		    				<input name="address" <?php if(!empty($delivery_info)): ?> value="<?php echo e($delivery_info->address); ?>" <?php endif; ?> type="hidden">
		    				<input name="zipcode" <?php if(!empty($delivery_info)): ?> value="<?php echo e($delivery_info->zip_code); ?>" <?php endif; ?>  type="hidden">
	                            ...
	                            <ul class="form-style-1">
	                                ...
	                                <li>
	                                	...
	                                	<div style="display: none;" id="chooseTime">
		                                    ...
		                                    <?php if($rec=="Delivery"): ?>
	                                    		delivery is 45-60 minutes
	                                    	<?php else: ?>
	                                    		collection is 20-30 mins
	                                    	<?php endif; ?>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$(".save-delivery-info").click(function(){
				...
				if(asap==0){ alert("Please select <?php echo e($rec); ?> time."); return false; }
