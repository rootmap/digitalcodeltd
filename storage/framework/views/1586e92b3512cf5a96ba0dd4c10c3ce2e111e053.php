        ...
        <div class="box box-danger">
            ...
            <form method="post" role="form" enctype="multipart/form-data" action="<?php echo e(url('admin-ecom/product-update')); ?>">
                <div class="box-body">
                    ...
                    <?php if($productOneSubLevel_count>0): ?>
                    ...
                    <div class="form-group multiple">
                        <table class="table table-responsive">
                            ...
                            <tbody id="proArea">
                                ...
                                <?php $__currentLoopData = $productOneSubLevel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($index+1); ?></td>
                                    <td><input type="text" name="spname[]" class="form-control" value="<?php echo e($row->name); ?>"></td>
                                    <td><input type="text" name="sdesc[]" class="form-control" value="<?php echo e($row->description); ?>"></td>
                                    <td><input size="2" type="text" name="smprice[]"  value="<?php echo e($row->price); ?>" class="form-control"></td>
