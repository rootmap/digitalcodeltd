                                        ...
                                        elseif($interface==4)
                                        {
                                            $modal.='<div class="modal" id="ex_modal-name_'.$row['id'].'">
                                                        ...
                                                        <div class="modal-box">
                                                           ...
                                                           foreach($row['ProductOneSubLevel'] as $itm):         
                                                           $modal.='<div class="form_popup bgbor">
                                                                        <div class="back_popup">
                                                                            <div class="cell-4" style="padding-top:12px;">
                                                ...
                                                <td width="20%" align="right" valign="top">
                                                    <div class="prosec">
                                                        <p class="proPrice">
                                                            ...
                                                            <a href="javascript:void(0);"  data-extra-id="<?php echo e($dt['id']); ?>" data-id="<?php echo e($row['id']); ?>" class="proButton add-subcat-cart"><i class="fa fa-plus"></i></a>
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
