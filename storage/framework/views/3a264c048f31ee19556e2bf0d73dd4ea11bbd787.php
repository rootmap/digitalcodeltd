            ...
            <div class="cell-9 top-menu">
                ...
                <nav class="top-nav mega-menu">
                    <ul>
                        ...
                        <li class="<?php echo e(Request::path() == 'our-offer' ? 'selected' : ''); ?>"><a href="<?php echo e(url('our-offer')); ?>"><i class="fa fa-gift"></i><span>Our Offers</span></a></li>
                        <li class="<?php echo e(Request::path() == 'table-booking' ? 'selected' : ''); ?>"><a href="<?php echo e(url('table-booking')); ?>"><i class="fa fa-cutlery"></i><span>Table Booking</span></a></li>
                        <li class="<?php echo e(Request::path() == 'gallery' ? 'selected' : ''); ?>"><a href="<?php echo e(url('gallery')); ?>"><i class="fa fa-picture-o"></i><span>Gallery</span></a></li>
                         ...
                         <li class="<?php echo e(Request::path() == 'reviews' ? 'selected' : ''); ?>"><a href="<?php echo e(url('reviews')); ?>"><i class="fa fa-comments"></i><span>Review</span></a></li>
