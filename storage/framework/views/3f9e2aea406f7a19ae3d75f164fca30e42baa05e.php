...
<?php $__env->startSection('seo'); ?>
    <meta name="description" content="<?php echo e($page_name); ?>">
    <meta name="keywords" content="<?php echo e($page_name); ?>">
...
<?php $__env->startSection('content'); ?>	
    <div class="page-title title-1">
        <div class="container">
            <div class="row">
                <div class="cell-12">
                    <h1 class="fx" data-animate="fadeInLeft"><?php echo e($page_name); ?></h1>
                    <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                        <span class="bold">You Are In:</span><a href="#">Home</a> <span class="line-separate">/</span><span> Other Page</span> <span class="line-separate">/</span><span> <?php echo e($page_name); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="sectionWrapper">
        <div class="container">
            <div class="row">
                 <p><?php echo html_entity_decode($extrapageData->description); ?></p>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>	
