...
<?php $__env->startSection('title','Inclusive Meal Info'); ?>
...
<ol class="breadcrumb">
    ...
    <li><a href="<?php echo e(url('admin-ecom/inclusive-meal/create')); ?>" class="active">Create New Inclusive Meal</a></li>
</ol>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-danger">
            ...
            <form method="post" role="form" enctype="multipart/form-data" action="<?php echo e(url('admin-ecom/inclusive-meal/save')); ?>">
                <div class="box-body">
                	<div class="row">
                		<div class="col-md-6">
