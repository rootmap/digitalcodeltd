...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-danger">
            ...
            <form method="post" enctype="multipart/form-data"  role="form" action="<?php echo e(url('admin-ecom/sub-category-add')); ?>">
                <div class="box-body">
...
<script id="edit_client" type="text/x-kendo-template">
    <a class="k-button k-button-icontext k-grid-delete" href="<?php echo e(url('admin-ecom/sub-category')); ?>/#= id #"><span class="k-icon k-edit"></span>Edit</a> 
