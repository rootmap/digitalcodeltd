						...
						<table class="table-style2">
							...
							<tbody id="scTab">
								...
								<?php if(isset($product)): ?>
									<?php $kkk=1; ?>
									<?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										
										<?php if(isset($pro['inclusiveMeal'])): ?>
										<tr id="sc-<?php echo e($index); ?>" data-cid="<?php echo e($index); ?>">
											<td class="width-10"><a class="remove-item" href="#"><i class="fa fa-times-circle"></i></a></td>
											<td>
												<b><?php echo e($pro['item']); ?> </b><br />
												<?php if(count($pro['flavour'])>0): ?>
													<?php $__currentLoopData = $pro['flavour']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<span>+<?php echo e($rr); ?></span><br />
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												<?php endif; ?>
											</td>
											<td class="width-50 center">£<span><?php echo e(number_format(($pro['price']/$pro['qty']),2)); ?></span></td>
											<td class="qty-txt-box">
												<input type="text" class="qtyyx" readonly="readonly" style="width: 60px !important;" value="<?php echo e($pro['qty']); ?>">
										...
										<?php else: ?>
										<tr id="sc-<?php echo e($pro['item']->id); ?>" data-cid="<?php echo e($pro['item']->cid); ?>">
											<td class="width-10"><a class="remove-item" href="#"><i class="fa fa-times-circle"></i></a></td>
											<td>
												<b>
...
<?php $__env->startSection('slider-js'); ?>
	<script type="text/javascript">
		var specialItemID="<?php echo e(env('SPECIALSETMENUID')); ?>";
		function upgradeCart(opt,itemID)
		{

                    var item_id=itemID;
                    var addtoCartURL="<?php echo e(url('addtocart/adjust')); ?>";
                    //------------------------Ajax POS Start-------------------------//
                    $.ajax({
                        'async': true,
                        'type': "POST",
