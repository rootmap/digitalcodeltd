...
<script>
        ...
        if(obj.rec!==null)
        {
            ...
            //var discType=$(".spend-discount-colndel").attr("data-disamount-type");
            //obj.rec
            console.log('Discount System Type',discType);
            console.log('Discount Site Type',obj.rec);
            ...
            $(document).ready(function(){
                ...
                $('.add-cart').click(function(){
                    ...
                    $.ajax({
                        ...
                        'dataType': 'json',
                        'url': addtoCartURL,
                        'data': {'item_id':item_id,'item_sub_cat_name':item_sub_cat_name,'_token':"<?php echo e(csrf_token()); ?>"},
                        'success': function (data) {
                            //tmp = data;
                            console.log("Processing : "+data);
                            loadCart(data);
