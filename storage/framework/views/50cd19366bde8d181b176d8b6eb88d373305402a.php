...
<h1>
    Shipping Info
    <small>Create Shipping & All Shipping List</small>
</h1>
<ol class="breadcrumb">
    <li><a href="#" class="active">Shipping Info</a></li>
</ol>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-plus"></i> Create New Shipping</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->

            <form method="post" role="form" enctype="multipart/form-data" action="<?php echo e(url('admin-ecom/shipping-add')); ?>">
                <div class="box-body">
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-table"></i> Shipping List</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
...
<script id="edit_client" type="text/x-kendo-template">
    <a class="k-button k-button-icontext k-grid-delete" href="<?php echo e(url('admin-ecom/shipping')); ?>/#= id #"><span class="k-icon k-edit"></span>Edit</a> 
...
$("#grid").kendoGrid({
    ...
    {field: "shippingimage", title: "Image", width: "150px"},
