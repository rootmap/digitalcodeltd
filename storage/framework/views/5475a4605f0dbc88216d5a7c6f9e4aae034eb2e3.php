                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tbody id="place_pro_<?php echo e($cat['id']); ?>">
                                    <?php if(!empty($cat['description'])): ?>
                                        <tr>
                                            <td colspan="3">
                                                <p class="proDes" style="text-transform: capitalize;">
                                    ...
                                    foreach ($cat['product_row'] as $key => $sc) 
                                    {
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                ...
                                                <small><?php echo e($sc['description']); ?></small>
                                            </td>
                                        </tr>
                                        <?php
                                        ...
                                        <tr>
                                            <td width="80%">
                                                <p class="proDes"><?php echo e($row['id']); ?>.<?php echo e($row['name']); ?>

                                                    <?php echo $row['description']?'<br>'.$row['description']:'';?>
                                                </p>
                                            </td>
                                            <td>
                                        ...
                                        <?php if($interface==2): ?>
                                            ...
                                            <tr>
                                                <td width="60%" align="left" valign="top">
                                                    <span class="proName" style="font-weight: 100 !important;"><?php echo e($row['id']); ?>.<?php echo e($dt['id']); ?>.<?php echo e($dt['name']); ?></span>
                                                </td>
