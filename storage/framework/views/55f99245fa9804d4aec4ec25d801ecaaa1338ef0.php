        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo e(url('admin-ecom/inclusive-meal/create')); ?>"><i class="fa fa-circle-o"></i> Create Inclusive Menu</a></li>
                            <li><a href="<?php echo e(url('admin-ecom/inclusive-meal')); ?>"><i class="fa fa-circle-o"></i> Inclusive Menu List</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo e(url('admin-ecom/enable-collection-only')); ?>"><i class="fa fa-plus"></i> Collection Only Setting</a></li>
                </ul>
            </li>
