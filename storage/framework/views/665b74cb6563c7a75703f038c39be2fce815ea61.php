                ...
                <ul class="right">
                    ...
                    <?php endif; ?>
                        ...
                        <?php elseif(isset($colndel)): ?>
                            data-disamount-limit="<?php echo e($colndel->minimum_amount); ?>" 
                             data-disamount-type="<?php echo e($colndel->discount_option); ?>" 
                            data-discount="<?php echo e($colndel->discount_amount); ?>"
                        <?php else: ?>
