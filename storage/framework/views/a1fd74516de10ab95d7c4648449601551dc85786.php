    ...
    <div class="col-md-12">
        ...
        <?php if(isset($data)): ?>
            <div class="box box-danger">
                ...
                <form  enctype="multipart/form-data"  method="post" role="form" action="<?php echo e(url('admin-ecom/customer-support-update')); ?>">
                    <div class="box-body">
            ...
            <div class="box box-danger">
                ...
                <form   method="post" role="form" action="<?php echo e(url('admin-ecom/customer-support-add')); ?>">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Customer Support Number</label>
