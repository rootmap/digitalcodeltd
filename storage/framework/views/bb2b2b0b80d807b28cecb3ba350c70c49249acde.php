...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-danger">
            ...
            <form method="post" role="form" enctype="multipart/form-data" action="<?php echo e(url('admin-ecom/welcome-content-add')); ?>">
...
<script id="edit_client" type="text/x-kendo-template">
    <a class="k-button k-button-icontext k-grid-delete" href="<?php echo e(url('admin-ecom/welcome-content')); ?>/#= id #"><span class="k-icon k-edit"></span>Edit</a> 
