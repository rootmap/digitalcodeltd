                    ...
                    <div class="tab_right_sidebar" id="mini_page_shopping_cart">
                        ...
                        <div class="mini-cart">
                            ...
                            <div class="mini-cart-total">
                                ...
                                <?php if(isset($common)): ?>
                                    <div  data-disamount-type="<?php echo e($common->discount_option); ?>"  class="clearfix spend-discount" data-disamount-limit="<?php echo e($common->minimum_amount); ?>" data-discount="<?php echo e($common->discount_amount); ?>">
                                ...
                                <?php elseif(isset($colndel)): ?>
                                    <?php $__currentLoopData = $colndel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cnd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div data-disamount-type="<?php echo e($cnd->discount_option); ?>" class="clearfix spend-discount-colndel spx-<?php echo e($cnd->discount_option); ?>" data-disamount-limit="<?php echo e($cnd->minimum_amount); ?>" data-discount="<?php echo e($cnd->discount_amount); ?>">
                                            <?php if(!empty($cnd->message)): ?>
                                            <div class="restaurantOffers">
                                                <p><?php echo e($cnd->message); ?></p>
                                            </div>
                                            <?php endif; ?>
                                        </div>
                            ...
                            <?php if($orderINfoText->isoffline==0): ?>
                            <div class="checkout">
