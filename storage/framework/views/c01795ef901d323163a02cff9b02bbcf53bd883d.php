            ...
            <form method="post" role="form" enctype="multipart/form-data" action="<?php echo e(url('admin-ecom/social-update')); ?>">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($data->social_section_title); ?>" id="social_section_title" name="social_section_title" placeholder="Enter Name">
