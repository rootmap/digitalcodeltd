...
<?php $__env->startSection('title','The Bombay Cottage'); ?>
	...
	<!-- Revolution slider start -->
                ...
                <div class="welcome">
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                <h3 class="center block-head"><span class="main-color">Welcome To The Bombay Cottage</span></h3>
                                <div class="cell-6">
                                    <p class="margin-bottom-0">The Bombay Cottage was established in 1993, situated in heart of Stamford, England’s finest stone built Town, The Restaurant is in a grade 2 listed building with exposed beams and stones.
                                        <br><br>
                                ...
                                <div class="cell-6">
                                    <p class="margin-bottom-0">  OUR MOTO- Our taste is simple,  We like the Best.!!                                                <br> <br>
                                        <img src="<?php echo e(url('front-theme/images/signature.jpg')); ?>" alt="signature of the manager"> <br>
                                        ………………………… <br> (Manager) <br>
                        ...
                        <div class="row">
                            <div class="cell-3 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="grid3column uppercase cus_image">
                                    <h3>Trip advisor</h3>
                                    <img alt="" src="<?php echo e(url('front-theme/images/content-front-bottom-picture-1.jpg')); ?>">
                            ...
                            <div class="cell-3 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="grid3column uppercase cus_image">
                                    <h3>Food Hygiene</h3>
                                    <img alt="" src="<?php echo e(url('front-theme/images/content-front-bottom-picture-3.jpg')); ?>">
                                    <a class="btn btn-md btn-3d btn-white fx animated fadeInUp" href="#" data-animate="fadeInUp" data-animation-delay="1700" style="animation-delay: 1700ms;">
                                        <span><i class="fa fa-chain selectedI"></i>read more...</span>
                                    </a>
                                </div>
                            ...
                            <div class="cell-3 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="grid3column uppercase cus_image">
                                    ...
                                    <img alt="" src="<?php echo e(url('front-theme/images/group_booking.jpg')); ?>">
                                    <a class="btn btn-md btn-3d btn-white fx animated fadeInUp" href="#" data-animate="fadeInUp" data-animation-delay="1700" style="animation-delay: 1700ms;">
                                        <span><i class="fa fa-chain selectedI"></i>read more...</span>
                                    </a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="cell-6 animated fadeInRight" data-animate="fadeInRight">
                                <div class="cus_pad_top">
                                    <img class="" src="<?php echo e(url('front-theme/images/devices_1.png')); ?>" alt="free delivery offer">
                                </div>
                            </div>
                                    ...
                                    <div class="testimonials-2">
                                        ...
                                        <div>
                                            <div class="testimonials-bg">
                                                <img alt="" src="<?php echo e(url('front-theme/images/people/1.jpg')); ?>" class="testimonials-img">
                ...
                <div class="sectionWrapper gry-bg">
                    <div class="container">
                        ...
                        <div class="clients">
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-1.png')); ?>"></a>
                            </div>
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-2.png')); ?>"></a>
                            </div>
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-3.png')); ?>"></a>
                            </div>
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-4.png')); ?>"></a>
                            </div>
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-5.png')); ?>"></a>
                            </div>
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-6.png')); ?>"></a>
                            </div>
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-7.png')); ?>"></a>
                            </div>
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-8.png')); ?>"></a>
                            </div>
                            <div>
                                <a class="white-bg" href="#"><img alt="" src="<?php echo e(url('front-theme/images/clients/client-9.png')); ?>"></a>
                            </div>
                        </div>
                    </div>
                </div>
