    ...
    <div class="col-md-12">
        ...
        if (isset($data)) {
            ...
            <div class="box box-danger">
                ...
                <form method="post" role="form" action="<?php echo e(url('admin-ecom/orders-email-update')); ?>">
                    <div class="box-body">
            ...
            <div class="box box-danger">
                ...
                <form method="post" role="form" action="<?php echo e(url('admin-ecom/orders-email-add')); ?>">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Primary Email</label>
