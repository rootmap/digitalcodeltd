...
<?php $__env->startSection('seo'); ?>
    <meta name="description" content="<?php echo e($Seo->contact_description); ?>">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="cell-6 contact-form">
                    ...
                    <form class="form-signin cform" method="post" action="<?php echo e(url('contact-request')); ?>" id="contact__form" autocomplete="on">
                        <?php echo csrf_field(); ?>
