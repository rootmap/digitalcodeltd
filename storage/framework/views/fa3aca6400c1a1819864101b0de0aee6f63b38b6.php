<div class="top-bar" data-sticky="true">
    <div class="container">
        <div class="row">
            <div class="cell-5">
                <ul>
                    <li><a href="mailto:<?php echo e($ContactDetail->contact_email); ?>"><i class="fa fa-envelope"></i><?php echo e($ContactDetail->contact_email); ?></a></li>
                    <li><a href="skype:<?php echo e($ContactDetail->contact_phone); ?>?call"><i class="fa fa-phone"></i> Call Us: <?php echo e($ContactDetail->contact_phone); ?></a></li>
                </ul>
            </div>
            <div class="cell-7 right-bar">
                <ul class="right">
                    ...
                    <?php if(Auth::check()): ?>
                        <li><a href="<?php echo e(url('user/dashboard')); ?>"><i class="fa fa-user"></i>Logged : <?php echo e(Auth::user()->name); ?></a></li>
